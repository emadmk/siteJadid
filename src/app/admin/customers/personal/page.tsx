...
import { User, Search, Mail, Phone, Eye, ArrowLeft } from 'lucide-react';
import { db } from '@/lib/db';

async function getPersonalCustomers(searchParams: { search?: string }) {
  const where: any = {
    accountType: { in: ['B2C', 'PERSONAL'] },
  };
...
export default async function PersonalCustomersPage({
  searchParams,
}: {
  searchParams: { search?: string };
}) {
  const customers = await getPersonalCustomers(searchParams);
    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Individual customer accounts</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="text-sm text-gray-600">Total Personal Buyers</div>
        </div>
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search personal buyers by name, email, or phone..."
          ...
          {customers.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-black mb-2">
                No personal buyers found
              </h3>
              <p className="text-gray-600">
                {searchParams.search
                  ? 'Try adjusting your search'
                  : 'No personal buyers registered yet'}
              </p>
            </div>
          ) : (
