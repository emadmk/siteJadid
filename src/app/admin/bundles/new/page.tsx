...
import { ArrowLeft, Save, Plus, X, Loader2, Search, Package } from 'lucide-react';
  ...
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Create a new product bundle or kit</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Safety Starter Kit"
                required
              />
            </div>
            <div>
                ...
                {searchResults.map((product) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">SKU: {product.sku} | ${Number(product.basePrice).toFixed(2)}</div>
                    </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-sm text-gray-500">Sum of all products</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Bundle Price *
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                {savings > 0 && retailValue > 0 ? `${((savings / retailValue) * 100).toFixed(0)}% off` : 'No savings'}
              </p>
            </div>
          </div>
